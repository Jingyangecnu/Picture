...
- R is a free software environment for <font color="#DC143C">**statistical computing**</font> and <font color="#DC143C">**graphics**</font>.
...
Example: [Work Log of Guochun Lab](file:///C:/Users/pro/Desktop/Untitled/Untitled.html#5)]
...
Official Tutorials: [幻灯忍者](https://slides.yihui.name/xaringan/zh-CN.html#1); [R语言交流学习](https://github.com/Jingyangecnu/Picture/blob/master/Untitled.html#1)]
...
- [An introduction to Stan with R](https://www.r-bloggers.com/an-introduction-to-stan-with-r/)<br />
...
background-position: 50% 87%
## Tips
### 1. Build and manage your knowledge base: 
...
background-position: 50% 87%
### 3. Use web Resource : Google keywords + r/Error   
--    
...
---
background-image: url(https://raw.githubusercontent.com/Jingyangecnu/R-language-learning-communication/master/分享学习.jpg.gif)
background-size: 600px  
background-position: 50% 65%
## Tips
...
---
## Tips
7. [Loop: for](https://baijiahao.baidu.com/s?id=1610503112508207963&wfr=spider&for=pc)
8. [Self-defining function](https://baijiahao.baidu.com/s?id=1610637261920764333&wfr=spider&for=pc)
9. ["apply" series of functions](http://blog.fens.me/r-apply/):apply; lapply; sapply; vapply; mapply; tapply; rapply; eapply
